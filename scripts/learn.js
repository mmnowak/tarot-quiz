 ...
 */
let cards = [
    '<div class="card-front"><img src="assets/images/tarot/fool.jpg" alt="The Fool"></img></div><div class="card-reverse"><p>Beginnings, innocence, spontaneity, a free spirit<button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#exampleModal">See more</button></p></div>',
